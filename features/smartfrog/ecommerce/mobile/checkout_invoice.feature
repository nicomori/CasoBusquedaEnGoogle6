...
Feature: Smartfrog - checkout invoice

  Scenario Outline: user can see the invoice after purchase
    ...
    #When I tap on Invoice email
    #Then I am redirected to Invoice email page
    #And I can see "Your invoice is now available"