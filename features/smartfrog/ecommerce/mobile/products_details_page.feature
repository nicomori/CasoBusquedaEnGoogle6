@Smoke @Core @Mobile @smartfrog @Ecommerce @Wip

Feature: Smartfrog - products details page

  Background:
    Given I detect the enviroment to execute the test
	Given I am on "Smartfrog" product details page
	
  Scenario: Mobile - Product details page verification 
    ...
    And I can see Product Price Element is displayed with correct data
      ...
      | Kostenloser Versand                                 |
 	And verify if this exclusive class "price-tag", appear in the web with this Table Of Text
      | 5,	 |
      | 95	 |
      | €	 |
      | nur	 |					     
